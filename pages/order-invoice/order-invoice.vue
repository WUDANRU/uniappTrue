<template>
	<view>
		...
		<card headTitle="发票类型" bodyPadding cardStyle="background:#ffffff;">
			...
			></zcm-radio-group>
			<view class="text-light-muted line-h-md font-2 pb-2 pl-2">
		...
		<view class="p-2 border-bottom d-flex a-center bg-white">
			<text class="font-3">个人姓名：</text>
			<text class="font-3 ml-2">个人</text>
		</view>
		<view class="p-2 border-bottom d-flex a-center bg-white">
			<text class="font-3">发票内容：</text>
			<text class="font-3 ml-2">商品明细</text>
		</view>
		<divider></divider>
		<view class="p-2 border-bottom d-flex a-center bg-white">
			<text class="font-3">收票人手机：</text>
			<text class="font-3 ml-2">158****123</text>
		</view>
		
		<view class="p-2 text-light-muted d-flex flex-column font-l">
			<text>发票须知：</text>
