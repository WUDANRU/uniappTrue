	...
	<view>
		...
		<card headTitle="申请售后的产品" cardStyle="background:#ffffff;">
			<view class="d-flex a-center px-3 py-2">
				...
				<view class="flex-1 ml-3">
					<view class="font-sm">商品名称</view>
					<view class="font-2 text-light-muted">
						维修服务：剩余111天
					</view>
				</view>
			</view>
		...
		<card headTitle="问题描述" bodyPadding cardStyle="background:#ffffff;">
			<view class="position-relative">
				...
				<view class="position-absolute text-light-muted font-3" 
		...
		<view class="p-3">
			<view class="rounded main-bg-color text-white text-center font-3 py-2"
